   ...
   return (
     <nav className=' bg-gradient-to-r from-purple-700 to-orange-500 p-4 text-white'>
       <div className='max-w-7xl mx-auto flex items-center justify-between'>
         ...
         {/* Menu Items */}
         <div
           className={`flex flex-col md:flex-row items-center md:space-x-8 space-y-4 md:space-y-0 bg-blue-500 md:bg-transparent w-full md:w-auto left-0 absolute md:static transition-all duration-500 ease-in-out ${
